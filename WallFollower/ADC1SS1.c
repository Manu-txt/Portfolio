...
// SS2 1st sample source: AIN3 (PE0) front
// SS2 2nd sample source: AIN2 (PE1) left
// SS2 3rd sample source: AIN1 (PE2) right
...
void ADC_Init321(void){
  ...
  ADC1_SSMUX1_R = 0x0123;       // 12) set channels for SS2 ain3 PE0, ain2 PE1, ain1 PE0
