...
#define FOLLOW_DIST 1680  // replace the zero with the ADC output value for object following distance
#define TOO_CLOSE 	2300  // replace the zero with the ADC output value for minimum distance
#define D30_CM      2300
...
// ain9 (PE4) 0 to 4095
// ain8 (PE5) 0 to 4095
void ADC_In321(uint16_t *ain3, uint16_t *ain2, uint16_t *ain1);
