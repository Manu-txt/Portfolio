...
// Modified by Dr. Min He, 4/8/2024
...
//#define TIMER0A_IRQ			19             // Interrupt request number for timer0A
#define TIMER1A_IRQ			21             // Interrupt request number for timer1A
...
void Timer1_Init(void(*task)(void), uint32_t period){
  ...
  NVIC_EN0_R |= 1<<TIMER1A_IRQ;  // 9) enable IRQ 21 in NVIC
...
void Timer1A_Handler(void){
  TIMER1_ICR_R = TIMER_ICR_TATOCINT;// acknowledge TIMER0A timeout
    ...
    (*PeriodicTask1)();  // Execute the assigned task safely
